...
function pm4() {
  return wc([z1,0.01,z2,0.03,z3,0.07,z4,0.24,z5,0.33,z6,0.25,z7,0.07]);
}
function pm5() {
...
const wht = [40, 2, 98],
  ...
  pcLx = function () {
    return wc([dRed,0.05,red,0.03,nwsprnt,0.12,orng,0.02,pYllw,0.06,yllw,0.06,pnk,0.03,grn,0.04,ppGrn,0.18,ddBlue,0.02,
      dBlue,0.05,blue,0.05,pBlue,0.03,brwn,0.17,dBrwn,0.09,ddBrwn,0.03]);
  },
  pcLxD1 = function () {
    return wc([dRed,0.1,pYllw,0.08,pnk,0.13,grn,0.2,ppGrn,0.16,dBlue,0.01,blue,0.24,pBlue,0.1,brwn,0.02]);
  },
  pcLxD2 = function () {
    return wc([dRed,0.12,red,0.1,nwsprnt,0.04,orng,0.05,pYllw,0.1,yllw,0.14,pnk,0.11,grn,0.13,ppGrn,0.05,
      dBlue,0.01,blue,0.12,pBlue,0.05]);
  },
  makeLxD = function () {
    const a = [],
      b = [0.6,0.12,0.1,0.05,0.03,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01];
  ...
  pbcLx = function (a) {
    return a >= V6
      ? wc([ddBlue,0.19,bgrndNws,0.3,ppGrn,0.15,pBlue,0.05,pnk,0.1,blue,0.1,grn,0.05,dRed,0.05,pYllw,0.01])
      : a >= V4
      ? wc([bgrndNws,0.6,pBlue,0.15,pppGrn,0.1,pPnk,0.1,bgrndDBlue,0.05])
      : wc([bgrndNws, 0.9, bgrndDBlue, 0.07, pppGrn, 0.03]);
  },
  pcRad = function () {
    return wc([wht,0.6,dRed,0.05,red,0.02,nwsprnt,0.05,orng,0.05,pYllw,0.05,yllw,0.03,ppGrn,0.01,blue,0.01,
      pBlue,0.04,brwn,0.09]);
  },
  pbcRad = function () {
    return bgrndNws;
  },
  pcBaked = function () {
    return wc([wht,0.2,pnk,0.05,pPnk,0.1,xGrn,0.5,ppYllwGrn,0.1,pBrwn,0.05]);
  },
  pbcBaked = function () {
    return bgrndNws;
  },
  pcCool = function () {
    return wc([nwsprnt,0.13,pYllw,0.01,lavender,0.03,grn,0.1,pppGrn,0.04,ppGrn,0.04,ddBlue,0.11,dBlue,0.15,
      blue,0.25,pBlue,0.1,brwn,0.01,dBrwn,0.04,ddBrwn,0.02]);
  },
  pbcCool = function (a) {
    return a >= V6
  ...
  pcRetro = function () {
    return wc([dRed,0.07,red,0.03,pOrng,0.05,pYllw,0.02,yllw,0.15,brwn,0.1,dBrwn,0.58]);
  },
  pbcRetro = function () {
  ...
  pbcWhtMono = function () {
    return wc([dRed,0.1,red,0.1,nwsprnt,0.01,orng,0.1,pYllw,0.04,yllw,0.05,pnk,0.1,grn,0.1,ddBlue,0.1,
      dBlue,0.1,blue,0.1,dBrwn,0.02,ddBrwn,0.02,blk,0.09]);
  },
  pcAM = function () {
    return wc([[260, 20, 20],0.77,[240, 30, 35],0.03,[300, 10, 50],0.05,[180, 20, 30],0.06,
      [130, 20, 70],0.05,[5, 10, 80],0.02,[5, 40, 90],0.01,[40, 25, 90],0.01]);
  },
  pbcAM = function () {
    return [260, 30, 30];
  },
  pcDarkLifestyle = function () {
    return wc([[0, 0, 13],0.2,[0, 0, 16],0.48,[0, 0, 19],0.2,[0, 0, 22],0.1,[0, 0, 25],0.02]);
  },
  ...
  pcGolfSocks = function () {
    return wc([bgrndNws,0.41,[210, 72, 45],0.15,[210, 72, 30],0.05,[0, 40, 95],0.07,[6, 20, 95],0.05,
      [130, 50, 30],0.2,[32, 30, 99],0.04,[32, 30, 30],0.03]);
  },
  pbcGolfSocks = function () {
    return [130, 20, 50];
  },
  pcRose = function () {
    return wc([[150, 8, 40],0.5,[160, 12, 25],0.05,[350, 60, 90],0.05,[350, 45, 80],0.05,[350, 80, 70],0.05,
      [6, 16, 100],0.2,[15, 26, 97],0.1]);
  },
  pbcRose = function () {
    return [150, 8, 30];
  },
...
function draw() {
  ...
  let a = wc([V1,0.03,V2,0.01,V3,0.04,V5,0.18,V6,0.5,V7,0.04,V4,0.2]);
  let b = wc(["none", 0.15, "low", 0.2, "med", 0.45, "high", 0.2]);
  V7 === a && (b = wc(["none", 0.4, "low", 0.3, "med", 0.3]));
  const c = wc([pi(0.5),0.1,pi(0),0.1,pi(0.25),0.2,pi(0.75),0.2,pi(0.05),0.1,pi(0.95),0.1,pi(0.45),0.1,pi(0.55),0.1]);
  const d = wc(["luxe",0.55,"gS",0.1,"rad",0.09,"bkd",0.05,"pltq",0.05,"wM",0.04,"AM",0.03,"rose",0.02,"blk",0.02,
      "cool",0.01,"wOC",0.01,"pG",0.01,"dL",0.01,"lD",0.01]);
  let e,f = null;
  "bkd" === d
